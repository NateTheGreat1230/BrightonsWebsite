<template>
    ...
    <div class="text-center text-white p-6 m-10 w-full bg-black bg-opacity-80 border-4 border-gray-700 rounded-lg shadow-lg max-w-md">
        ...
        <form @submit.prevent="submitForm" class="flex flex-col">
            ...
            <button type="submit" class=" hover:underline border-white border-2 rounded-lg text-white px-6 py-2 mt-4">Send Message</button>
        </form>
    </div>
    </div>
</template>
