...
declare function getIconCollections<T extends CollectionNames>(include: T[]): Record<T, IconifyJSON>;
...
export { type CollectionNames, type IconsPluginOptions, dynamicIconsPlugin, getIconCollections, iconsPlugin };
